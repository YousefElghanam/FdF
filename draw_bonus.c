...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/06/30 22:25:47 by jel-ghna          #+#    #+#             */
/*   Updated: 2025/06/30 22:25:48 by jel-ghna         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	set_coordinates(t_map *map, t_co *co, int x, int y)
{
	...
	co->iso_y = (co->rot_x + co->rot_y) * sinf(map->c_angle_y * (PI / 180.0f))
		- co->raw_z;
}
...
static void	swap_imgs(t_win *win)
{
	t_img	*tmp;
